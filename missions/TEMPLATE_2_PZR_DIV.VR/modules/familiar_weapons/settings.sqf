...
familiarWeapons_reloadSuccessChance = 66;
familiarWeapons_reloadFailureChance = 33;
...
// Weapon sets may be added together using the + symbol
// For example:
