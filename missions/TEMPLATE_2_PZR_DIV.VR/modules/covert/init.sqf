["Covert", "Allows a side to blend in with AI as long as they don't do anything suspicious or hostile.", "Wilhelm Haas (Drofseh)"] call FNC_RegisterModule;
