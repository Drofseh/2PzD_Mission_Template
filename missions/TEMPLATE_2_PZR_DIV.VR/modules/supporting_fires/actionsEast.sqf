...
#define def_setFireMission(BOOL) \
    fireMissionAvailableEAST = BOOL; \
    publicVariable "fireMissionAvailableEAST";

#define def_removeShellsHE(NUMBER) \
    shellsHE_AmmoCountEAST = shellsHE_AmmoCountEAST - NUMBER; \
    publicVariable "shellsHE_AmmoCountEAST";

#define def_removeShellsSmoke(NUMBER) \
    shellsSmoke_AmmoCountEAST = shellsSmoke_AmmoCountEAST - NUMBER; \
    publicVariable "shellsSmoke_AmmoCountEAST";

#define def_removeShellsFlare(NUMBER) \
    shellsFlare_AmmoCountEAST = shellsFlare_AmmoCountEAST - NUMBER; \
    publicVariable "shellsFlare_AmmoCountEAST";

#define def_TargetVisual \
    _target = screenToWorld [0.5,0.5]; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
    _targetX = (_target select 0) + (random [-shellAccuracyEAST, 0, shellAccuracyEAST]); \
    _targetY = (_target select 1) + (random [-shellAccuracyEAST, 0, shellAccuracyEAST]);

#define def_Target01 \
    _target = getMarkerPos target01EAST; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
...
#define def_Target02 \
    _target = getMarkerPos target02EAST; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
...
#define def_Target03 \
    _target = getMarkerPos target03EAST; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
...
#define def_Target04 \
    _target = getMarkerPos target04EAST; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
...
#define def_Target05 \
    _target = getMarkerPos target05EAST; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
...
#define def_Target06 \
    _target = getMarkerPos target06EAST; \
    previousTarget = _target; \
    shellDispersionEAST = originalShellDispersionEAST; \
    shellAccuracyEAST = originalShellAccuracyEAST; \
    repeatFire = 1; \
...
#define def_TargetRepeat \
    ...
    repeatShellAccuracyEAST = shellAccuracyEAST / repeatFire; \
    shellDispersionEAST = shellDispersionEAST / repeatFire; \
    _targetX = (previousTarget select 0) + (random [-repeatShellAccuracyEAST, 0, repeatShellAccuracyEAST]); \
    _targetY = (previousTarget select 1) + (random [-repeatShellAccuracyEAST, 0, repeatShellAccuracyEAST]);

#define def_barrage5RoundsHE_EAST \
    _bomb = shellsHE_TypeEAST createVehicle [_targetX,_targetY,300]; \
    _bombPosition = _bomb getPos [random shellDispersionEAST, random 360]; \
...
#define def_barrage5RoundsSmoke_EAST \
    _bomb = shellsSmoke_TypeEAST createVehicle [_targetX,_targetY,300]; \
    _bombPosition = _bomb getPos [random shellDispersionEAST, random 360]; \
    _bombPositionX = (_bombPosition select 0); \
    _bombPositionY = (_bombPosition select 1); \
    _bomb setPos [_bombPositionX,_bombPositionY,300]; \
...
#define def_barrage1RoundFlare_EAST \
    _bomb = shellsFlare_TypeEAST createVehicle [_targetX,_targetY,300]; \
    _bombPosition = _bomb getPos [random shellDispersionEAST, random 360]; \
    _bombPositionX = (_bombPosition select 0); \
    _bombPositionY = (_bombPosition select 1); \
    _bomb setPos [_bombPositionX,_bombPositionY,300]; \
...
#define def_barrage5RoundsFlare_EAST \
    _bomb = shellsFlare_TypeEAST createVehicle [_targetX,_targetY,300]; \
    _bombPosition = _bomb getPos [random shellDispersionEAST, random 360]; \
    _bombPositionX = (_bombPosition select 0); \
    _bombPositionY = (_bombPosition select 1); \
...
_supportingFireActions = call {
    ...
    _conditionTargets      = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsHE_AmmoCountEAST >= 5 || shellsSmoke_AmmoCountEAST >= 5 || shellsFlare_AmmoCountEAST >= 5)};
    _conditionRepeat       = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (!(previousTarget isEqualTo [])) && (shellsHE_AmmoCountEAST >= 5 || shellsSmoke_AmmoCountEAST >= 5 || shellsFlare_AmmoCountEAST >= 1)};
    _conditionFiresHE5     = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsHE_AmmoCountEAST >= 5)};
    _conditionFiresHE10    = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsHE_AmmoCountEAST >= 10)};
    _conditionFiresHE15    = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsHE_AmmoCountEAST >= 15)};
    _conditionFiresHE20    = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsHE_AmmoCountEAST >= 20)};
    _conditionFiresHE25    = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsHE_AmmoCountEAST >= 25)};
    _conditionFiresSmoke5  = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsSmoke_AmmoCountEAST >= 5)};
    _conditionFiresSmoke10 = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsSmoke_AmmoCountEAST >= 10)};
    _conditionFiresFlare1  = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsFlare_AmmoCountEAST >= 1)};
    _conditionFiresFlare5  = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST) && (shellsFlare_AmmoCountEAST >= 5)};
    _conditionCheck        = {([] call acre_api_fnc_getCurrentRadio != "") && (fireMissionAvailableEAST)};
    _conditionFiring       = {([] call acre_api_fnc_getCurrentRadio != "") && (!fireMissionAvailableEAST)};
    ...
    _statementRounds = {
        [] spawn {
            ...
            sleep 5;
            hint format ["%1 Rounds, HE,\n%2 rounds Smoke,\n%3 rounds Flare,\nremaining.", shellsHE_AmmoCountEAST, shellsSmoke_AmmoCountEAST, shellsFlare_AmmoCountEAST];
        };
    };
    ...
    _statementVisualLoc_5 = {
        ...
        [] spawn {
            ...
            */
            ...
            sleep 30;
            hint format ["Rounds complete.\n30 seconds to impact.\n%1 rounds remaining.", shellsHE_AmmoCountEAST];
            def_setFireMission(True);
            sleep 30;
            def_barrage5RoundsHE_EAST;
        };
    };
    ...
    _statementVisualLocS_5 = {
        ...
        [] spawn {
            ...
            hint "Roger, Fire Mission,\n5 Rounds, Smoke,\nOn your Mark.";
            sleep 30;
            hint format ["Rounds complete.\n30 seconds to impact.\n%1 rounds remaining.", shellsSmoke_AmmoCountEAST];
            def_setFireMission(True);
            sleep 30;
            def_barrage5RoundsSmoke_EAST;
        };
    };
    ...
    _statementVisualLocF_1 = {
        ...
        [] spawn {
            ...
            hint "Roger, Fire Mission,\n1 Round, Flare,\nOn your Mark.";
            sleep 30;
            hint format ["Rounds complete.\n30 seconds to impact.\n%1 rounds remaining.", shellsFlare_AmmoCountEAST];
            def_setFireMission(True);
            sleep 30;
            def_barrage1RoundFlare_EAST;
        };
    };
    ...
    if (target01EAST != "") then {
        _actionTarget01 = [target01EAST_Name,target01EAST_Name,"",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionTarget01] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01_15] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01_20] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01_25] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01S_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01S_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01F_1] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target01EAST_Name], _actionTarget01F_5] call ace_interact_menu_fnc_addActionToObject;
        };

    // Add Target 02 interaction
    if (target02EAST != "") then {
        _actionTarget02 = [target02EAST_Name,target02EAST_Name,"",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionTarget02] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02_15] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02_20] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02_25] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02S_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02S_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02F_1] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target02EAST_Name], _actionTarget02F_5] call ace_interact_menu_fnc_addActionToObject;
        };

    // Add Target 03 interaction
    if (target03EAST != "") then {
        _actionTarget03 = [target03EAST_Name,target03EAST_Name,"",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionTarget03] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03_15] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03_20] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03_25] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03S_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03S_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03F_1] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target03EAST_Name], _actionTarget03F_5] call ace_interact_menu_fnc_addActionToObject;
        };

    // Add Target 04 interaction
    if (target04EAST != "") then {
        _actionTarget04 = [target04EAST_Name,target04EAST_Name,"",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionTarget04] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04_15] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04_20] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04_25] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04S_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04S_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04F_1] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target04EAST_Name], _actionTarget04F_5] call ace_interact_menu_fnc_addActionToObject;
        };

    // Add Target 05 interaction
    if (target05EAST != "") then {
        _actionTarget05 = [target05EAST_Name,target05EAST_Name,"",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionTarget05] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05_15] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05_20] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05_25] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05S_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05S_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05F_1] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target05EAST_Name], _actionTarget05F_5] call ace_interact_menu_fnc_addActionToObject;
        };

    // Add Target 06 interaction
    if (target06EAST != "") then {
        _actionTarget06 = [target06EAST_Name,target06EAST_Name,"",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionTarget06] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06_15] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06_20] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06_25] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06S_5] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06S_10] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06F_1] call ace_interact_menu_fnc_addActionToObject;
            ...
            [player, 1, ["ACE_SelfActions","Supporting Fires",target06EAST_Name], _actionTarget06F_5] call ace_interact_menu_fnc_addActionToObject;
        };
    ...
    _statementRepeat_5 = {
        ...
        [] spawn {
            ...
            sleep 30;
            def_barrage5RoundsHE_EAST;
            shellAccuracyEAST = repeatShellAccuracyEAST;
        };
    };
