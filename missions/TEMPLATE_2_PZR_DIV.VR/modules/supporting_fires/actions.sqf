...
_supportingFireActions = call {
    ...
    _conditionTargets      = {
           (([] call acre_api_fnc_getCurrentRadio != "") && {side player isEqualTo WEST}       && {supportFire_fireMissionAvailableWEST} && {supportFire_shellsHE_AmmoCountWEST > 4 || supportFire_shellsSmoke_AmmoCountWEST > 4 || supportFire_shellsFlare_AmmoCountWEST > 4})
        || {([] call acre_api_fnc_getCurrentRadio != "") && {side player isEqualTo EAST}       && {supportFire_fireMissionAvailableEAST} && {supportFire_shellsHE_AmmoCountEAST > 4 || supportFire_shellsSmoke_AmmoCountEAST > 4 || supportFire_shellsFlare_AmmoCountEAST > 4}}
        || {([] call acre_api_fnc_getCurrentRadio != "") && {side player isEqualTo RESISTANCE} && {supportFire_fireMissionAvailableGUER} && {supportFire_shellsHE_AmmoCountGUER > 4 || supportFire_shellsSmoke_AmmoCountGUER > 4 || supportFire_shellsFlare_AmmoCountGUER > 4}}
    };
    _conditionVisual      = {
           (([] call acre_api_fnc_getCurrentRadio != "") && {!visibleMap} && {side player isEqualTo WEST}       && {supportFire_fireMissionAvailableWEST} && {supportFire_shellsHE_AmmoCountWEST > 4 || supportFire_shellsSmoke_AmmoCountWEST > 4 || supportFire_shellsFlare_AmmoCountWEST > 4})
        || {([] call acre_api_fnc_getCurrentRadio != "") && {!visibleMap} && {side player isEqualTo EAST}       && {supportFire_fireMissionAvailableEAST} && {supportFire_shellsHE_AmmoCountEAST > 4 || supportFire_shellsSmoke_AmmoCountEAST > 4 || supportFire_shellsFlare_AmmoCountEAST > 4}}
        || {([] call acre_api_fnc_getCurrentRadio != "") && {!visibleMap} && {side player isEqualTo RESISTANCE} && {supportFire_fireMissionAvailableGUER} && {supportFire_shellsHE_AmmoCountGUER > 4 || supportFire_shellsSmoke_AmmoCountGUER > 4 || supportFire_shellsFlare_AmmoCountGUER > 4}}
    };
    _conditionRepeat       = {
           (([] call acre_api_fnc_getCurrentRadio != "") && {side player isEqualTo WEST}       && {supportFire_fireMissionAvailableWEST} && {!(supportFire_previousTarget isEqualTo [])} && {supportFire_shellsHE_AmmoCountWEST > 4 || supportFire_shellsSmoke_AmmoCountWEST > 4 || supportFire_shellsFlare_AmmoCountWEST >= 1})
        || {([] call acre_api_fnc_getCurrentRadio != "") && {side player isEqualTo EAST}       && {supportFire_fireMissionAvailableEAST} && {!(supportFire_previousTarget isEqualTo [])} && {supportFire_shellsHE_AmmoCountEAST > 4 || supportFire_shellsSmoke_AmmoCountEAST > 4 || supportFire_shellsFlare_AmmoCountEAST >= 1}}
        || {([] call acre_api_fnc_getCurrentRadio != "") && {side player isEqualTo RESISTANCE} && {supportFire_fireMissionAvailableGUER} && {!(supportFire_previousTarget isEqualTo [])} && {supportFire_shellsHE_AmmoCountGUER > 4 || supportFire_shellsSmoke_AmmoCountGUER > 4 || supportFire_shellsFlare_AmmoCountGUER >= 1}}
    };
    _conditionFiresHE1     = {
