    ...
    if (supportFire_target01 != "") then {
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target01_Name], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 01, 1 Round, HE
            _statementTarget01_1 = { [(side player), "HE", 1, "Target01", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget01_1 = ["HE - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget01_1,_conditionFiresHE1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target01_Name,"HE"], _actionTarget01_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 01, 5 Rounds, HE
            _statementTarget01_5 = { [(side player), "HE", 5, "Target01", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget01_5 = ["HE - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget01_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget01_10 = ["HE - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget01_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget01_15 = ["HE - 15 Rounds","15 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget01_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget01_20 = ["HE - 20 Rounds","20 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget01_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget01_25 = ["HE - 25 Rounds","25 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget01_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target01_Name], _actionBaseSmoke] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementTarget01S_1 = { [(side player), "Smoke", 1, "Target01", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget01S_1 = ["Smoke - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget01S_1,_conditionFiresSmoke1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target01_Name,"Smoke"], _actionTarget01S_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 01, 5 Rounds, Smoke
            _statementTarget01S_5 = { [(side player), "Smoke", 5, "Target01", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget01S_5 = ["Smoke - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget01S_5,_conditionFiresSmoke5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget01S_10 = ["Smoke - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget01S_10,_conditionFiresSmoke10] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target01_Name], _actionBaseFlare] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget01F_1 = ["Flare - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget01F_1,_conditionFiresFlare1] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget01F_5 = ["Flare - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget01F_5,_conditionFiresFlare5] call ace_interact_menu_fnc_createAction;
