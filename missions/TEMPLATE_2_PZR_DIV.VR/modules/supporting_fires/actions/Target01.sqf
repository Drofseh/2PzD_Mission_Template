    ...
    if (supportFire_target01 != "") then {
        ...
        _actionTarget01 = [supportFire_target01_Name,supportFire_target01_Name,"modules\supporting_fires\icons\icon_supporting_fires_target.paa",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
