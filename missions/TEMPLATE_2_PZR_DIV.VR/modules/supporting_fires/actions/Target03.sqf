    ...
    if (supportFire_target03 != "") then {
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target03_Name], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget03_5 = ["HE - 5 Rounds","HE - 5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget03_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget03_10 = ["HE - 10 Rounds","HE - 10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget03_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget03_15 = ["HE - 15 Rounds","HE - 15 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget03_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget03_20 = ["HE - 20 Rounds","HE - 20 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget03_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget03_25 = ["HE - 25 Rounds","HE - 25 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget03_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target03_Name], _actionBaseSmoke] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget03S_5 = ["Smoke - 5 Rounds","Smoke - 5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget03S_5,_conditionFiresSmoke5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget03S_10 = ["Smoke - 10 Rounds","Smoke - 10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget03S_10,_conditionFiresSmoke10] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target03_Name], _actionBaseFlare] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget03F_1 = ["Flare - 1 Round","Flare - 1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget03F_1,_conditionFiresFlare1] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget03F_5 = ["Flare - 5 Rounds","Flare - 5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget03F_5,_conditionFiresFlare5] call ace_interact_menu_fnc_createAction;
