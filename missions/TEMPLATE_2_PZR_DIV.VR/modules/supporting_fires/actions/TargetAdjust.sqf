    ...
    [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionAdjust] call ace_interact_menu_fnc_addActionToObject;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_N] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50N = ["Adjust North 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustN.paa",_statementAdjust_50N,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100N = ["Adjust North 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustN.paa",_statementAdjust_100N,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_NE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50NE = ["Adjust Northeast 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustNE.paa",_statementAdjust_50NE,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100NE = ["Adjust Northeast 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustNE.paa",_statementAdjust_100NE,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_E] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50E = ["Adjust East 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustE.paa",_statementAdjust_50E,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100E = ["Adjust East 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustE.paa",_statementAdjust_100E,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_SE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50E = ["Adjust Southeast 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustSE.paa",_statementAdjust_50SE,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100SE = ["Adjust Southeast 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustSE.paa",_statementAdjust_100SE,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_S] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50S = ["Adjust South 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustS.paa",_statementAdjust_50S,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100S = ["Adjust South 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustS.paa",_statementAdjust_100S,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_SW] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50SW = ["Adjust Southwest 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustSW.paa",_statementAdjust_50SW,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100SW = ["Adjust Southwest 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustSW.paa",_statementAdjust_100SW,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_W] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50W = ["Adjust West 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustW.paa",_statementAdjust_50W,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100W = ["Adjust West 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustW.paa",_statementAdjust_100W,_conditionRepeat] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_NW] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionAdjust_50NW = ["Adjust Northwest 50","50m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustNW.paa",_statementAdjust_50NW,_conditionRepeat] call ace_interact_menu_fnc_createAction;
            ...
            _actionAdjust_100NW = ["Adjust Northwest 100","100m","Haas_WWII_Rebalance\UI\icon_supporting_fires_adjustNW.paa",_statementAdjust_100NW,_conditionRepeat] call ace_interact_menu_fnc_createAction;
