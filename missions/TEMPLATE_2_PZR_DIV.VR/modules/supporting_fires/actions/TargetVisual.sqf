    ...
    [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionVisualLoc] call ace_interact_menu_fnc_addActionToObject;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Visual Location"], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionVisualLocHE_5 = ["HE - 5 Rounds","HE - 5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementVisualLocHE_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_10 = ["HE - 10 Rounds","HE - 10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementVisualLocHE_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_15 = ["HE - 15 Rounds","HE - 15 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementVisualLocHE_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_20 = ["HE - 20 Rounds","HE - 20 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementVisualLocHE_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_25 = ["HE - 25 Rounds","HE - 25 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementVisualLocHE_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Visual Location"], _actionBaseSmoke] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionVisualLocS_5 = ["Smoke - 5 Rounds","Smoke - 5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementVisualLocS_5,_conditionFiresSmoke5] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocS_10 = ["Smoke - 10 Rounds","Smoke - 10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementVisualLocS_10,_conditionFiresSmoke10] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Visual Location"], _actionBaseFlare] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionVisualLocF_1 = ["Flare - 1 Round","Flare - 1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementVisualLocF_1,_conditionFiresFlare1] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocF_5 = ["Flare - 5 Rounds","Flare - 5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementVisualLocF_5,_conditionFiresFlare5] call ace_interact_menu_fnc_createAction;
