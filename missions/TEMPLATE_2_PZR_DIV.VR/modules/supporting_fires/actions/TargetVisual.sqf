    ...
    [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionVisualLoc] call ace_interact_menu_fnc_addActionToObject;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Visual Location"], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionVisualLocHE_5 = ["HE - 5 Rounds","HE - 5 Rounds","modules\supporting_fires\icons\icon_supporting_fires_he.paa",_statementVisualLocHE_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_10 = ["HE - 10 Rounds","HE - 10 Rounds","modules\supporting_fires\icons\icon_supporting_fires_he.paa",_statementVisualLocHE_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_15 = ["HE - 15 Rounds","HE - 15 Rounds","modules\supporting_fires\icons\icon_supporting_fires_he.paa",_statementVisualLocHE_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_20 = ["HE - 20 Rounds","HE - 20 Rounds","modules\supporting_fires\icons\icon_supporting_fires_he.paa",_statementVisualLocHE_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionVisualLocHE_25 = ["HE - 25 Rounds","HE - 25 Rounds","modules\supporting_fires\icons\icon_supporting_fires_he.paa",_statementVisualLocHE_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
