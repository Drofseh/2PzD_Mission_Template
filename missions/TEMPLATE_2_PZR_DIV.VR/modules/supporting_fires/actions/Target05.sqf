    ...
    if (supportFire_target05 != "") then {
        ...
        _actionTarget05 = [supportFire_target05_Name,supportFire_target05_Name,"modules\supporting_fires\icons\icon_supporting_fires_target.paa",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
