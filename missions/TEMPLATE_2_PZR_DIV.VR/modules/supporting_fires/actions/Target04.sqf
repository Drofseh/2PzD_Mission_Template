    ...
    if (supportFire_target04 != "") then {
        ...
        _actionTarget04 = [supportFire_target04_Name,supportFire_target04_Name,"modules\supporting_fires\icons\icon_supporting_fires_target.paa",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
