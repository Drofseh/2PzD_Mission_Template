    ...
    if (supportFire_target04 != "") then {
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target04_Name], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 04, 1 Round, HE
            _statementTarget04_1 = { [(side player), "HE", 1, "Target04", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget04_1 = ["HE - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget04_1,_conditionFiresHE1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target04_Name,"HE"], _actionTarget04_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 04, 5 Rounds, HE
            _statementTarget04_5 = { [(side player), "HE", 5, "Target04", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget04_5 = ["HE - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget04_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget04_10 = ["HE - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget04_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget04_15 = ["HE - 15 Rounds","15 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget04_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget04_20 = ["HE - 20 Rounds","20 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget04_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget04_25 = ["HE - 25 Rounds","25 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget04_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target04_Name], _actionBaseSmoke] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 04, 1 Round, Smoke
            _statementTarget04S_1 = { [(side player), "Smoke", 1, "Target04", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget04S_1 = ["Smoke - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget04S_1,_conditionFiresSmoke1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_Target04_Name,"Smoke"], _actionTarget04S_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 04, 5 Rounds, Smoke
            _statementTarget04S_5 = { [(side player), "Smoke", 5, "Target04", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget04S_5 = ["Smoke - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget04S_5,_conditionFiresSmoke5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget04S_10 = ["Smoke - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget04S_10,_conditionFiresSmoke10] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target04_Name], _actionBaseFlare] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget04F_1 = ["Flare - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget04F_1,_conditionFiresFlare1] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget04F_5 = ["Flare - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget04F_5,_conditionFiresFlare5] call ace_interact_menu_fnc_createAction;
