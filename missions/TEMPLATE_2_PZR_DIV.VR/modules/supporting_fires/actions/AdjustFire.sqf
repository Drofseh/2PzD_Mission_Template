    ...
    _statementAdjust = {
        [["Select the direction and distance to adjust fire,"],[format ["Current adjustment is %1.", supportFire_adjustmentDirection]]] call CBA_fnc_notify;
    };
    ...
    [player, 1, ["ACE_SelfActions","Supporting Fires"], _actionAdjust] call ace_interact_menu_fnc_addActionToObject;
        ...
        _statementAdjustNone = {
            ...
            "No fire adjustments selected." call CBA_fnc_notify;
        };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_N] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50N = {
                ...
                "Adjust fire 50m north.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100N = {
                ...
                "Adjust fire 100m north.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_NE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50NE = {
                ...
                "Adjust fire 50m northeast.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100NE = {
                ...
                "Adjust fire 100m northeast.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_E] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50E = {
                ...
                "Adjust fire 50m east.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100E = {
                ...
                "Adjust fire 100m east.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_SE] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50SE = {
                ...
                "Adjust fire 50m southeast.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100SE = {
                ...
                "Adjust fire 100m southeast.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_S] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50S = {
                ...
                "Adjust fire 50m south.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100S = {
                ...
                "Adjust fire 100m south.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_SW] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50SW = {
                ...
                "Adjust fire 50m southwest.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100SW = {
                ...
                "Adjust fire 100m southwest.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_W] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50W = {
                ...
                "Adjust fire 50m west.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100W = {
                ...
                "Adjust fire 100m west.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires","Adjust Fire"], _actionAdjust_NW] call ace_interact_menu_fnc_addActionToObject;
            ...
            _statementAdjust_50NW = {
                ...
                "Adjust fire 50m northwest.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
            ...
            _statementAdjust_100NW = {
                ...
                "Adjust fire 100m northwest.<br/>Select the type of ammunition to use." call CBA_fnc_notify;
            };
