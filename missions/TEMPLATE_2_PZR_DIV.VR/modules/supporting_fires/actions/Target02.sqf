    ...
    if (supportFire_target02 != "") then {
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target02_Name], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 02, 1 Round, HE
            _statementTarget02_1 = { [(side player), "HE", 1, "Target02", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget02_1 = ["HE - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget02_1,_conditionFiresHE1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target02_Name,"HE"], _actionTarget02_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 02, 5 Rounds, HE
            _statementTarget02_5 = { [(side player), "HE", 5, "Target02", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget02_5 = ["HE - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget02_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget02_10 = ["HE - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget02_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget02_15 = ["HE - 15 Rounds","15 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget02_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget02_20 = ["HE - 20 Rounds","20 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget02_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget02_25 = ["HE - 25 Rounds","25 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget02_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target02_Name], _actionBaseSmoke] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 02, 1 Round, Smoke
            _statementTarget02S_1 = { [(side player), "Smoke", 1, "Target02", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget02S_1 = ["Smoke - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget02S_1,_conditionFiresSmoke1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_Target02_Name,"Smoke"], _actionTarget02S_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 02, 5 Rounds, Smoke
            _statementTarget02S_5 = { [(side player), "Smoke", 5, "Target02", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget02S_5 = ["Smoke - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget02S_5,_conditionFiresSmoke5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget02S_10 = ["Smoke - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget02S_10,_conditionFiresSmoke10] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target02_Name], _actionBaseFlare] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget02F_1 = ["Flare - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget02F_1,_conditionFiresFlare1] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget02F_5 = ["Flare - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget02F_5,_conditionFiresFlare5] call ace_interact_menu_fnc_createAction;
