    ...
    if (supportFire_target02 != "") then {
        ...
        _actionTarget02 = [supportFire_target02_Name,supportFire_target02_Name,"modules\supporting_fires\icons\icon_supporting_fires_target.paa",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
