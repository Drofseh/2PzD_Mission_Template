    ...
    if (supportFire_target06 != "") then {
        ...
        _actionTarget06 = [supportFire_target06_Name,supportFire_target06_Name,"Haas_WWII_Rebalance\UI\icon_supporting_fires_target.paa",_statementTargets,_conditionTargets] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target06_Name], _actionBaseHE] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 06, 1 Round, HE
            _statementTarget06_1 = { [(side player), "HE", 1, "Target06", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget06_1 = ["HE - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget06_1,_conditionFiresHE1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target06_Name,"HE"], _actionTarget06_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 06, 5 Rounds, HE
            _statementTarget06_5 = { [(side player), "HE", 5, "Target06", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget06_5 = ["HE - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget06_5,_conditionFiresHE5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget06_10 = ["HE - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget06_10,_conditionFiresHE10] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget06_15 = ["HE - 15 Rounds","15 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget06_15,_conditionFiresHE15] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget06_20 = ["HE - 20 Rounds","20 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget06_20,_conditionFiresHE20] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget06_25 = ["HE - 25 Rounds","25 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_he.paa",_statementTarget06_25,_conditionFiresHE25] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target06_Name], _actionBaseSmoke] call ace_interact_menu_fnc_addActionToObject;
            ...
            // Target 06, 1 Round, Smoke
            _statementTarget06S_1 = { [(side player), "Smoke", 1, "Target06", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget06S_1 = ["Smoke - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget06S_1,_conditionFiresSmoke1] call ace_interact_menu_fnc_createAction;
            [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_Target06_Name,"Smoke"], _actionTarget06S_1] call ace_interact_menu_fnc_addActionToObject;

            // Target 06, 5 Rounds, Smoke
            _statementTarget06S_5 = { [(side player), "Smoke", 5, "Target06", [0,0]] call FNC_SupportFire_FireMission; };
            _actionTarget06S_5 = ["Smoke - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget06S_5,_conditionFiresSmoke5] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget06S_10 = ["Smoke - 10 Rounds","10 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_smoke.paa",_statementTarget06S_10,_conditionFiresSmoke10] call ace_interact_menu_fnc_createAction;
        ...
        [player, 1, ["ACE_SelfActions","Supporting Fires",supportFire_target06_Name], _actionBaseFlare] call ace_interact_menu_fnc_addActionToObject;
            ...
            _actionTarget06F_1 = ["Flare - 1 Round","1 Round","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget06F_1,_conditionFiresFlare1] call ace_interact_menu_fnc_createAction;
            ...
            _actionTarget06F_5 = ["Flare - 5 Rounds","5 Rounds","Haas_WWII_Rebalance\UI\icon_supporting_fires_flare.paa",_statementTarget06F_5,_conditionFiresFlare5] call ace_interact_menu_fnc_createAction;
