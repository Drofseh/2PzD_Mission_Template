...
if (zeusFog_visibleSides isEqualTo [civilian]) then {
    "Zeus Fog of War system only has civilians set to be visible. You probably want the Zeus to be able to see another side as well. This must be done in the settings.sqf." call FNC_DebugMessage;
};
