...
//Squad
    ...
    //Scout
    USMC42Oct_Scout = ["USMC42Oct_Scout", {
        params ["_unit"];
...
//Mortar Team
    ...
    //Mortar Team Leader
    USMC42Oct_MortTL = ["USMC42Oct_MortTL", {
        params ["_unit"];
    ...
    //Mortar Gunner
    USMC42Oct_MortG = ["USMC42Oct_MortG", {
        params ["_unit"];
    ...
    //Mortar Assistant
    USMC42Oct_MortA = ["USMC42Oct_MortA", {
        params ["_unit"];
    ...
    //Mortar Ammo Bearer
    USMC42Oct_MortAB = ["USMC42Oct_MortAB", {
        params ["_unit"];
...
//Bazooka Team
    ...
    //Bazooka Team Leader
    USMC42Oct_BzkaTL = ["USMC42Oct_BzkaTL", {
        params ["_unit"];
    ...
    //Bazooka Gunner
    USMC42Oct_BzkaG = ["USMC42Oct_BzkaG", {
        params ["_unit"];
    ...
    //Bazooka Ammo Bearer
    USMC42Oct_BzkaAB = ["USMC42Oct_BzkaAB", {
        params ["_unit"];
...
//Tank Crew
    ...
    //Tank Crew
    USMC42Oct_VCrew = ["USMC42Oct_VCrew", {
        params ["_unit"];
