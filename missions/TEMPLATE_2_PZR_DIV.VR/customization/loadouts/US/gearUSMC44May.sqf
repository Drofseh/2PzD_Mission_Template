...
//Squad
    ...
    //Scout
    USMC44May_Scout = ["USMC44May_Scout", {
        params ["_unit"];
...
//Mortar Team
    ...
    //Mortar Team Leader
    USMC44May_MortTL = ["USMC44May_MortTL", {
        params ["_unit"];
    ...
    //Mortar Gunner
    USMC44May_MortG = ["USMC44May_MortG", {
        params ["_unit"];
    ...
    //Mortar Assistant
    USMC44May_MortA = ["USMC44May_MortA", {
        params ["_unit"];
    ...
    //Mortar Ammo Bearer
    USMC44May_MortAB = ["USMC44May_MortAB", {
        params ["_unit"];
...
//Bazooka Team
    ...
    //Bazooka Team Leader
    USMC44May_BzkaTL = ["USMC44May_BzkaTL", {
        params ["_unit"];
    ...
    //Bazooka Gunner
    USMC44May_BzkaG = ["USMC44May_BzkaG", {
        params ["_unit"];
    ...
    //Bazooka Ammo Bearer
    USMC44May_BzkaAB = ["USMC44May_BzkaAB", {
        params ["_unit"];
...
//Tank Crew
    ...
    //Tank Crew
    USMC44May_VCrew = ["USMC44May_VCrew", {
        params ["_unit"];
