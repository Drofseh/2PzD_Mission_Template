...
//Squad
    ...
    //Scout
    USMC44Jan_Scout = ["USMC44Jan_Scout", {
        params ["_unit"];
...
//Mortar Team
    ...
    //Mortar Team Leader
    USMC44Jan_MortTL = ["USMC44Jan_MortTL", {
        params ["_unit"];
    ...
    //Mortar Gunner
    USMC44Jan_MortG = ["USMC44Jan_MortG", {
        params ["_unit"];
    ...
    //Mortar Assistant
    USMC44Jan_MortA = ["USMC44Jan_MortA", {
        params ["_unit"];
    ...
    //Mortar Ammo Bearer
    USMC44Jan_MortAB = ["USMC44Jan_MortAB", {
        params ["_unit"];
...
//Bazooka Team
    ...
    //Bazooka Team Leader
    USMC44Jan_BzkaTL = ["USMC44Jan_BzkaTL", {
        params ["_unit"];
    ...
    //Bazooka Gunner
    USMC44Jan_BzkaG = ["USMC44Jan_BzkaG", {
        params ["_unit"];
    ...
    //Bazooka Ammo Bearer
    USMC44Jan_BzkaAB = ["USMC44Jan_BzkaAB", {
        params ["_unit"];
...
//Tank Crew
    ...
    //Tank Crew
    USMC44Jan_VCrew = ["USMC44Jan_VCrew", {
        params ["_unit"];
