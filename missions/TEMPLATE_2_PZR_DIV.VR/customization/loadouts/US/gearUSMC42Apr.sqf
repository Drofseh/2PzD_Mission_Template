...
//Squad
    ...
    //Scout
    USMC42Apr_Scout = ["USMC42Apr_Scout", {
        params ["_unit"];
...
//Mortar Team
    ...
    //Mortar Team Leader
    USMC42Apr_MortTL = ["USMC42Apr_MortTL", {
        params ["_unit"];
    ...
    //Mortar Gunner
    USMC42Apr_MortG = ["USMC42Apr_MortG", {
        params ["_unit"];
    ...
    //Mortar Assistant
    USMC42Apr_MortA = ["USMC42Apr_MortA", {
        params ["_unit"];
    ...
    //Mortar Ammo Bearer
    USMC42Apr_MortAB = ["USMC42Apr_MortAB", {
        params ["_unit"];
...
//Tank Crew
    ...
    //Tank Crew
    USMC42Apr_VCrew = ["USMC42Apr_VCrew", {
        params ["_unit"];
