...
//Platoon
    ...
    //Light Mortar Gunner
    UKSEA43Jan_LMortG = ["UKSEA43Jan_LMortG", {
        params ["_unit"];
    ...
    UKSEA43Jan_LMortA = ["UKSEA43Jan_LMortA", {
        params ["_unit"];
...
//Squad
    ...
    //Lance Corporal
    UKSEA43Jan_LCpl = ["UKSEA43Jan_LCpl", {
        params ["_unit"];
...
//Machine Gun Team
    ...
    UKSEA43Jan_MGTL = ["UKSEA43Jan_MGTL", {
        params ["_unit"];
    ...
    UKSEA43Jan_MGAB = ["UKSEA43Jan_MGAB", {
        params ["_unit"];
...
//Mortar Team
    ...
    //Mortar Team Leader
    UKSEA43Jan_MortTL = ["UKSEA43Jan_MortTL", {
        params ["_unit"];
    ...
    //Mortar Gunner
    UKSEA43Jan_MortG = ["UKSEA43Jan_MortG", {
        params ["_unit"];
    ...
    //Mortar Assistant
    UKSEA43Jan_MortA = ["UKSEA43Jan_MortA", {
        params ["_unit"];
    ...
    //Mortar Ammo Bearer
    UKSEA43Jan_MortAB = ["UKSEA43Jan_MortAB", {
        params ["_unit"];
...
//Boys Rifle Team
    ...
    UKSEA43Jan_ATRTL = ["UKSEA43Jan_ATRTL", {
        params ["_unit"];
    ...
    //Boys Rifle Gunner
    UKSEA43Jan_ATRG = ["UKSEA43Jan_ATRG", {
        params ["_unit"];
    ...
    UKSEA43Jan_ATRAB = ["UKSEA43Jan_ATRAB", {
        params ["_unit"];
...
//PIAT Team
    ...
    //PIAT Team Leader
    UKSEA43Jan_ATTL = ["UKSEA43Jan_ATTL", {
        params ["_unit"];
    ...
    //PIAT Ammo Bearer
    UKSEA43Jan_ATAB = ["UKSEA43Jan_ATAB", {
        params ["_unit"];
...
//Vehicle Crew
    ...
    //Tank Commander
    UKSEA43Jan_VCom = ["UKSEA43Jan_VCom", {
        params ["_unit"];
    ...
    //Tank Crew
    UKSEA43Jan_VCrew = ["UKSEA43Jan_VCrew", {
        params ["_unit"];
