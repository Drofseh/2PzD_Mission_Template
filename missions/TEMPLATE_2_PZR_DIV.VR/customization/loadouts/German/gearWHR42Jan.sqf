...
/*Loadouts
    ...
    //Kompanietrupp
[this, WHR42Jan_CC] call Olsen_FW_FNC_GearScript;        Kompanieführer
[this, WHR42Jan_C2] call Olsen_FW_FNC_GearScript;        Kompanietruppführer

    //Zugtrupp
[this, WHR42Jan_PC] call Olsen_FW_FNC_GearScript;        Zugführer
[this, WHR42Jan_P2] call Olsen_FW_FNC_GearScript;        Zugtruppführer
[this, WHR42Jan_RTO] call Olsen_FW_FNC_GearScript;       Funker
[this, WHR42Jan_Mess] call Olsen_FW_FNC_GearScript;      Melder
[this, WHR42Jan_MedP] call Olsen_FW_FNC_GearScript;      Krankenträger

    //Gruppe
[this, WHR42Jan_SL] call Olsen_FW_FNC_GearScript;        Gruppenführer
[this, WHR42Jan_S2] call Olsen_FW_FNC_GearScript;        Stellvertretender Gruppenführer
[this, WHR42Jan_S3] call Olsen_FW_FNC_GearScript;        Gefreiter
[this, WHR42Jan_MG] call Olsen_FW_FNC_GearScript;        MG-Richtschütze
[this, WHR42Jan_MGA] call Olsen_FW_FNC_GearScript;       MG-Hilfsschütze
[this, WHR42Jan_MGAB] call Olsen_FW_FNC_GearScript;      MG-Munitionsträger
[this, WHR42Jan_Gren] call Olsen_FW_FNC_GearScript;      Grenadier
[this, WHR42Jan_MedS] call Olsen_FW_FNC_GearScript;      Hilfs-Krankenträger
[this, WHR42Jan_Rif] call Olsen_FW_FNC_GearScript;       Gewehrschütze

    //Weapon Truppen
[this, WHR42Jan_MortSL] call Olsen_FW_FNC_GearScript;    Mortar Truppführer
[this, WHR42Jan_MortG] call Olsen_FW_FNC_GearScript;     Mortar Granatwerferschützen
[this, WHR42Jan_MortA] call Olsen_FW_FNC_GearScript;     Mortar Munitionsträger

[this, WHR42Jan_HMGSL] call Olsen_FW_FNC_GearScript;     HMG Truppführer
[this, WHR42Jan_HMGG] call Olsen_FW_FNC_GearScript;      HMG Richtschütze
[this, WHR42Jan_HMGA] call Olsen_FW_FNC_GearScript;      HMG Munitionsträger

[this, WHR42Jan_ATRSL] call Olsen_FW_FNC_GearScript;     Panzerbüchse Truppführer
[this, WHR42Jan_ATRG] call Olsen_FW_FNC_GearScript;      Panzerbüchse Richtschütze
[this, WHR42Jan_ATRA] call Olsen_FW_FNC_GearScript;      Panzerbüchse Munitionsträger

    //Tank Crew
[this, WHR42Jan_VCom] call Olsen_FW_FNC_GearScript;      Besatzungsführer
[this, WHR42Jan_VCrew] call Olsen_FW_FNC_GearScript;     Besatzung
*/

//======================== Definitions ========================

//For Kompanieführer, Kompanietruppführer, Zugführer, Zugtruppführer, and Besatzungsführer
#define WHR42Jan_Weapon_Officer \
        [ \
            [ \
                [Ger_Mag_MP40,1], \
                [Ger_Weap_MP40], \
...
#define WHR42Jan_Weapon_Rifleman \
        [ \
            [ \
                [Ger_Mag_K98,1], \
...
#define WHR42Jan_Weapon_Officer_Secondary \
        [ \
            [ \
                [Ger_Mag_P38,1], \
                [Ger_Weap_P38], \
...
#define WHR42Jan_Weapon_Enlisted_Secondary \
        [ \
            [ \
                [Ger_Mag_P38,1], \
                [Ger_Weap_P38], \
...
//Company HQ
    ...
    WHR42Jan_CC = ["WHR42Jan_CC", {
        ...
        //Primary Weapon
        WHR42Jan_Weapon_Officer;

        //Secondary Weapon
        WHR42Jan_Weapon_Officer_Secondary;
    }];

    //Kompanietruppführer
    WHR42Jan_C2 = ["WHR42Jan_C2", {
        params ["_unit"];
        ...
        //Secondary Weapon
        WHR42Jan_Weapon_Enlisted_Secondary;
    }];

//Platoon HQ

    //Zugführer
    WHR42Jan_PC = ["WHR42Jan_PC", {
        params ["_unit"];
    ...
    WHR42Jan_RTO = ["WHR42Jan_RTO", {
        ...
        //Primary Weapon
        WHR42Jan_Weapon_Rifleman;
    }];

    //Melder
    WHR42Jan_Mess = ["WHR42Jan_Mess", {
        params ["_unit"];
...
//Weapon Truppen
    ...
    //Mortar Team
    //Mortar Truppführer
    WHR42Jan_MortSL = ["WHR42Jan_MortSL", {
        params ["_unit"];
