["In-game briefing utilities", "Allows an admin to trigger various commands that will help maintain order during in-game briefings.", "BlackHawk"] call Olsen_FW_FNC_RegisterModule;
