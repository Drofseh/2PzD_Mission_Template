...
//Updated: July 19, 2017
    ...
    Olsen_FW_FNC_aiCover = {
        params ["_unit","_down","_up"]; //[OBJECT,[0.5,"DOWN"],[0.6,"MIDDLE"]] call Olsen_FW_FNC_aiCover;
        ...
        [_unit] call Olsen_FW_FNC_addCover;
    };

    Olsen_FW_FNC_addRecover = {
    ...
    Olsen_FW_FNC_addCover = {
        ...
        if (alive _unit) then {
            [{morale (_this select 0) < (_this select 1) || !alive (_this select 0)},{
                ...
                _unit setUnitPos _state;
                [_unit] call Olsen_FW_FNC_addRecover;
            },[_unit,_morale,_state]] call CBA_fnc_waitUntilAndExecute;
        };
    };