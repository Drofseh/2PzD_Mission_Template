["AI drivers", "Adds AI commanded by players as drivers to vehicles.", "BlackHawk"] call Olsen_FW_FNC_RegisterModule;
...
aidrivers_removeUnit = {
    ...
    false call Olsen_FW_FNC_toggleDriverCam;
...
VEHS call Olsen_FW_FNC_enableAIDriver;