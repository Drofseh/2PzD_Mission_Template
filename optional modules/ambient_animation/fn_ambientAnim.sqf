...
private["_attachOffset","_attachObj","_attachSpecsAuto","_attachSpecs","_attachSnap","_noBackpack","_noWeapon","_randomGear","_weapon","_forcedSnapPoint","_params"];
    ...
    _params = _animset call Olsen_FW_FNC_ambientAnimParams;
...
*/
    ...
    [_unit,_attachObj,_attachSpecs,_azimutFix,_attach] spawn {
        ...
        if (isNull _logic) exitWith {
            _unit call Olsen_FW_FNC_ambientAnimPlay;
        ...
        [
            "AnimDone", {
                ...
                if (alive _unit) then {
                    ...
                    _unit call Olsen_FW_FNC_ambientAnimTerminate;
                };
            }
        ];
        ...
        [
            "Killed",
            {
                (_this select 0) call Olsen_FW_FNC_ambientAnimTerminate;
            }
        ];
