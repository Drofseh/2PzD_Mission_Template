...
player createDiaryRecord ["Partisan",["Avoiding Trouble","
    <br/><font color='#70db70' size='16'>Things That Will Get You In Trouble As A Civilian Or Partisan:</font>
    <br/>
    <br/><font color='#FF8C00' size='14'>Carrying a visible weapon.</font>
    ...
    <br/>
    <br/><font color='#FF8C00' size='14'>Wearing forbidden gear.</font>
    ...
    <br/>
    <br/><font color='#70db70' size='16'>Things That Will Get You In Trouble While Wearing An Enemy Uniform:</font>
    <br/>
    <br/><font color='#FF8C00' size='14'>Not wearing enemy headgear.</font>
    ...
    <br/>
    <br/><font color='#FF8C00' size='14'>A raised weapon.</font>
...
player createDiaryRecord ["Partisan",["How It Works","
    ...
    <br/>
    <br/><font color='#FF8C00' size='14'>1. Avoid trouble.</font>
    <br/><font color='#FF8C00' size='14'>2. Kill the enemy.</font>
    <br/><font color='#FF8C00' size='14'>3. Steal the enemy's equipment.</font>
    <br/><font color='#FF8C00' size='14'>4. Destroy the enemy's things.</font>
    <br/>
