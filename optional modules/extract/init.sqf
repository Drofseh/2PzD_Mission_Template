["Extract", "When called, the module will spawn an AI controlled vehicle and will wait until all players are mounted before extracting.", "Starfox64"] call Olsen_FW_FNC_RegisterModule;

Olsen_FW_FNC_Extract = {
...
Olsen_FW_FNC_CheckArrayInVeh = {
    ...
    _total = {_x call Olsen_FW_FNC_Alive} count _units;
