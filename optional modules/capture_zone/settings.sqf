...
//Example:["east",[west,east],[300,10]] call Olsen_FW_FNC_setCaptureZone;
//Author:       Sacher

//Definition:   [MARKERNAME,[SIDES],[WINS]] call Olsen_FW_FNC_setCaptureZone;
...
//Comments: In endConditions.sqf add MARKERNAMEINQUOTES call Olsen_FW_FNC_isCaptured;
//          will return "EAST","WEST","CIVILIAN","RESISTANCE","NONE" depending on who captured it
//          Example:if ("EAST" == "marker" call Olsen_FW_FNC_isCaptured) exitWith {};

//Additional:

// SECONDS call Olsen_FW_FNC_setIntervall;
// time between checks if people have entered the capturezone
// use under your own discretion
// Default: 15

// [BLUCOLOR,EASTCOLOR,RESISTANCECOLOR,CIVILIAN,CONDESTEDCOLOR,UNCONDESTEDCOLOR] call Olsen_FW_FNC_setColors;
// will set Capturezone colors
// Default: ["ColorBlue","ColorRed","ColorGreen","ColorYellow","ColorWhite","ColorKhaki"];
// Example ["ColorBlue","ColorRed","ColorGreen","ColorYellow","ColorWhite","ColorKhaki"] call Olsen_FW_FNC_setColors;

// [BLUSTRING,EASTSTRING,RESISTANCESTRING,CIVLIANSTRIN,CONTESTEDSTRING,UNCONDESTEDSTRING] call Olsen_FW_FNC_setMessages;
...
// Example ["Blufor is capturing the zone","Opfor is capturing the zone","Resistance is capturing the zone","Civilian is capturing the zone","The zone is contested","The zone is uncontested"] call Olsen_FW_FNC_setMessages;


//["","","","","",""] call Olsen_FW_FNC_setMessages;