    ...
    Olsen_FW_FNC_processHelpers = {
        ...
        {   //Large Pink Arrows - Burning Vehicle
            ...
            ]],"Olsen_FW_FNC_particleEffect",true,true] spawn BIS_fnc_MP;
            [{[_this,"Olsen_FW_FNC_audio_carBurning2",true,true] spawn BIS_fnc_MP},_x,_delay] call CBA_fnc_waitAndExecute;
        ...
        {   //Pink Arrows - Small Fire
            ...
            [{[_this,"Olsen_FW_FNC_audio_carBurning1",true,true] spawn BIS_fnc_MP},_x,_delay] call CBA_fnc_waitAndExecute;
            _hideArray set [count _hideArray,_x];
        } forEach (allMissionObjects "Sign_Arrow_Pink_F");

        [_hideArray,"Olsen_FW_FNC_hideHelperObjects",true,true] spawn BIS_fnc_MP;
